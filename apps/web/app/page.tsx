...
const emptyDistribution: Record<MoodType, number> = {
  confused: 0,
  bored: 0,
  neutral: 0,
  engaged: 0,
...
export default function Home() {
  ...
  const applyLectureState = (state: LectureState) => {
    if (!state) return;
    setDistribution(state.distribution ?? emptyDistribution);
        ...
        <>
          <header className={styles.header}>
            <div>
              ...
              <p className={styles.subhead}>
                Create a room, share the code, and watch student sentiment
          ...
          <section className={styles.heroGrid}>
            <div className={styles.heroCard}>
              ...
              <p className={styles.subhead}>
                See mood shifts as they happen and collect ideas without
